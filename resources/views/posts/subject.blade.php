            ...
            <div class="flex flex-col lg:flex-row lg:space-x-12 mb-12">
                ...
                @foreach ($subjectslist as $subject)
                    ...
                    <div class="mx-auto bg-white rounded-xl shadow overflow-hidden mb-6 group">
                        <div class="p-8 flex justify-start">
                            <span class="inline-flex items-center justify-center px-2 py-1 text-xs font-bold leading-none text-white bg-indigo-600 rounded">{{ $loop->index+1}}</span>
                            <h3 class="mt-1 text-lg leading-tight font-medium text-black group-hover:text-red-600 pl-5 flex">{{ __('主題分類') }}
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mx-4" viewBox="0 0 20 20" fill="currentColor">
