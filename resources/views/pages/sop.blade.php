...
<div class="flex justify-center items-center text-white w-full bg-gradient-to-r from-blue-900 to-blue-500"  style="height:150px;">
  <h2 class="text-4xl font-bold">:: {{ __('租車流程') }}</h2>
</div>
@stop
  ...
  <path d="M10.707 2.293a1 1 0 00-1.414 0l-7 7a1 1 0 001.414 1.414L4 10.414V17a1 1 0 001 1h2a1 1 0 001-1v-2a1 1 0 011-1h2a1 1 0 011 1v2a1 1 0 001 1h2a1 1 0 001-1v-6.586l.293.293a1 1 0 001.414-1.414l-7-7z" />
            ...
            <section class="max-w-7xl mx-auto px-4 lg:px-0 mt-12 mb-12">
                <article>
                    ...
                    @foreach($sops as $sop)
                    <h1 class="text-3xl font-bold">{{ $sop->title }}</h1>
                    <p class="font-thin">{!! $sop->body !!}</p>
                    <div class="flex justify-end">
                        <p class="text-gray-600 flex">{{ __('更新時間') }}：{{$sop->updated_at}}</p>
                    </div>
                    @endforeach
                    </section>
                </article>
